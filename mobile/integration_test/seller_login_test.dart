...
void main() {
  ...
  testWidgets('login as seller', (tester) async {
    app.main();
    await tester.pump();
    ...
    await tester.tap(find.text('بائع'));
    await tester.pump();
    ...
    await waitFor(tester, find.text('سياراتي'));
    expect(find.textContaining('Owner Demo'), findsOneWidget);
  });
}
